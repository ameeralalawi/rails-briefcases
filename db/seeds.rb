...
Case.create!({
  ...
  :user_output_text => "If you invest in our product, you will earn @BAEndofPeriodVal euros per year and recover the initial cost in @ABEndofPeriodVal. In more details, the value of your investment after year one will be of @FirstBreakeveInMonths. ",
